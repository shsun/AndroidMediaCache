...
public class VitamioMediaController extends MediaController {
    ...
    private View.OnClickListener backListener = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            if (v.getId() == R.id.mediacontroller_play_next) {
    ...
    protected View makeControllerView() {
        View v = ((LayoutInflater) getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(getResources().getIdentifier("ui_media_controller", "layout", getContext().getPackageName()), this);
