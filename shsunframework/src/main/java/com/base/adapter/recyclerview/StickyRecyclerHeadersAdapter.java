package com.base.adapter.recyclerview;
...
public interface StickyRecyclerHeadersAdapter<VH extends RecyclerView.ViewHolder> {
    ...
    /**
     * Creates a new BaseViewHolder for a header.  This works the same way onCreateViewHolder in
    ...
    /**
     * Binds an existing BaseViewHolder to the specified adapter position.
     *
